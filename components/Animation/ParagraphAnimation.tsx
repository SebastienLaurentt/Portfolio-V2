...
export default function ParagraphAnimation() {
  ...
  return (
    <motion.p
      ...
      style={{ opacity }}
    >
Originaire du domaine des neurosciences, mon but est aujourd&apos;hui  d&apos;utiliser les connaissances acquises sur le fonctionnement cerebral pour creer des applications web offrant une experience utilisateur fluide et intuitive.
    </motion.p>
  );
}
